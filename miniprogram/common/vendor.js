...
if (!Math) {
  ...
  "../pages/space/create.js";
  "../pages/space/invite.js";
  "../pages/category/list.js";
  "../pages/task/create.js";
  "../pages/memory/list.js";
  "../pages/me/settings.js";
}
var define_import_meta_env_default = { VITE_WECHAT_CLOUD_ENV: "" };
const env = typeof { url: typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("common/vendor.js", document.baseURI).href } !== "undefined" ? define_import_meta_env_default || {} : {};
const RUNTIME_CONFIG = {
  wechatCloudEnv: env.VITE_WECHAT_CLOUD_ENV || ""
};
function getWechatCloudEnv() {
  return RUNTIME_CONFIG.wechatCloudEnv;
}
const _sfc_main = {
  onLaunch() {
    {
      if (!(wx$1 == null ? void 0 : wx$1.cloud)) {
        console.warn("[runtime] wx.cloud is unavailable in current environment");
      } else {
        const cloudEnv = getWechatCloudEnv();
        wx$1.cloud.init({
          env: cloudEnv || void 0,
          traceUser: true
        });
        if (!cloudEnv) {
          console.warn("[runtime] VITE_WECHAT_CLOUD_ENV is empty, using the default cloud environment from WeChat DevTools");
        }
      }
    }
    console.log("亲密空间启动");
...
const App$1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
function createApp() {
...
function getThemeByScore(score = 50) {
  return THEME_PRESETS.find((theme) => score <= theme.maxScore) || THEME_PRESETS[THEME_PRESETS.length - 1];
}
function callFunction(name, data = {}) {
  return new Promise((resolve, reject) => {
    ...
    wx$1.cloud.callFunction({
      name,
      data,
      success: (res) => {
        const payload = res == null ? void 0 : res.result;
        if ((payload == null ? void 0 : payload.code) && payload.code !== 0) {
          reject(new Error(payload.message || "微信云函数调用失败"));
          return;
        }
        resolve((payload == null ? void 0 : payload.data) ?? payload);
      },
      fail: reject
    });
  });
}
const wxCloudAdapter = {
...
const getState = (...args) => adapter.getState(...args);
const createSpace = (...args) => adapter.createSpace(...args);
const acceptInvite = (...args) => adapter.acceptInvite(...args);
const createCategory = (...args) => adapter.createCategory(...args);
const approveCategory = (...args) => adapter.approveCategory(...args);
const createTask = (...args) => adapter.createTask(...args);
const completeTask = (...args) => adapter.completeTask(...args);
const dissolveSpace = (...args) => adapter.dissolveSpace(...args);
...
exports.dissolveSpace = dissolveSpace;
exports.e = e;
exports.f = f;
exports.getState = getState;
exports.getThemeByScore = getThemeByScore;
exports.index = index;
exports.o = o;
exports.t = t;
